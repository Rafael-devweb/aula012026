            ...
            {Usuarios.map((usuario) => (
              <tr key={usuario.codigo} className="transition-colors hover:bg-emerald-500/5">
                ...
                <td className="px-6 py-4">
                  <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-bold border ${usuario.ativo
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      ...
                      className={`rounded border px-3 py-1 text-[10px] font-black uppercase tracking-widest transition-all ${usuario.ativo
